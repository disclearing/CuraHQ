  ...
  implements Listener
{
  public static ItemStack getEventSign(String playerName, String kothName)
  {
    ...
    meta.setLore(Lists.newArrayList(new String[] { ChatColor.AQUA + Core.getPlugin().getFactionManager().getFaction(playerName).getName(), ChatColor.GRAY + "captured by", ChatColor.AQUA + ChatColor.stripColor(name), ChatColor.GRAY + DateTimeFormats.DAY_MTH_HR_MIN.format(System.currentTimeMillis()) }));
