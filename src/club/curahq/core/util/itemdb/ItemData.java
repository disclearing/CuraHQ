package club.curahq.core.util.itemdb;
...
public class ItemData implements ConfigurationSerializable {
    ...
    public String getItemName() {
        return BasePlugins.getPlugin().getItemDb().getName(new ItemStack(this.material, 1, this.itemData));
    }

    @SuppressWarnings("deprecation")
	public static ItemData fromItemName(final String string) {
        final ItemStack stack = BasePlugins.getPlugin().getItemDb().getItem(string);
